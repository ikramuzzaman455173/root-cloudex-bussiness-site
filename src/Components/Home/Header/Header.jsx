    ...
    <>
      ...
      <div className="flex lg:flex-row md:flex-col flex-col lg:justify-center items-center relative lg:-top-[9rem] md:-top-[2rem]">
        <div className='lg:text-left md:text-center text-center'>
          <p className='text-white text-[18px] fw-[700]'>YOU HAVE THE <span className='text-[#FFA500]'>IDEA</span></p>
          <h3 className='text-[2.5rem] font-[700] text-white'>WE HAVE THE <span className='text-[#FFA500]'>TECHNOLOGY</span></h3>
          ...
          {/* <h3 className=' font-[500] text-[18px]'>
            ...
            <span className='text-white lg:block hidden'>
              <div className="typewriter-container bg-[#008CFF] p-2 mt-4 rounded-md inline-block">
                <Typewriter words={['Web Application Based Interface', 'Develop And Design', 'Client Management']} loop={true} cursor={<Cursor />} />
              </div>
            </span>
            <br />
...
//     <>
//       {/* ====header div-1===== */}
//       <div className="flex lg:flex-row md:flex-col flex-col lg:justify-center items-center relative lg:-top-[9rem] md:-top-[2rem] bg-[#121E34]">
//         <div className='lg:text-left md:text-center text-center'>
...
//             {' '}
//             <span className='text-white lg:block hidden'>
//               <div className="typewriter-container bg-[#008CFF] p-2 rounded-md inline-block">
//                 <Typewriter words={['Web Application Based Interface', 'Develop And Design', 'Client Management']} loop={true} cursor={<Cursor />} />
//               </div>
//             </span>
//             <br />
