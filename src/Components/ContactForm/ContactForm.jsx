  ...
  return (
    <>
      ...
      <div className="container">
        <h2 className=' capitalize md:font-[700] font-[600] md:text-[34px] text-[28px] md:mb-8 mb-4 text-center text-white'> get in touch</h2>
        <div data-aos="fade-right" data-aos-duration="1500" className="md:flex justify-between gap-6 border-2 shadow-md items-center p-5 rounded-md">
