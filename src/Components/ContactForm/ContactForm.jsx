      ...
      <h2 className=' capitalize md:font-[700] font-[600] md:text-[34px] text-[28px] md:mb-8 mb-4 text-center text-white pb-5'> get in touch</h2>
        <div className="md:flex justify-between gap-6 border-2 shadow-md items-center p-5 rounded-md">
          <div className="w-full md:w-1/2 h-[350px] sm:h-[450px] g-map border-[#1E6DFF] border-[1px] p-2 rounded-lg custom-drop-software-develop-section">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3644.373998714976!2d89.24553337477283!3d24.017873178456362!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fe8502e6d41b9f%3A0xfa11e70528c9262d!2sAyesha%20Monjil!5e0!3m2!1sen!2sbd!4v1711117240951!5m2!1sen!2sbd"className='border-0 w-full h-full rounded-md' allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
