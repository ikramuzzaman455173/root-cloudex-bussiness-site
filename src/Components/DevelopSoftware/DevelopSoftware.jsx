  ...
  const cardData = [
    {
      ...
      imageUrl: "./assets/softwareDevelopSectionImg/softwareImg-1.png",
    },
    {
      id: 2,
      title: "Analysis",
      description: "Gather and document project requirements.",
      imageUrl: "./assets/softwareDevelopSectionImg/softwareImg-2.png",
    },
    {
      id: 3,
      title: "Design",
      ...
      imageUrl: "./assets/softwareDevelopSectionImg/softwareImg-3.png",
    },
    {
      id: 4,
      title: "Coding",
      ...
      imageUrl: "./assets/softwareDevelopSectionImg/softwareImg-4.png",
    },
    {
      id: 5,
      title: "Testing",
      description: "Test the system components and integrate them into a working system.",
      imageUrl: "./assets/softwareDevelopSectionImg/softwareImg-5.png",
    },
    {
      id: 6,
      title: "Development",
      description: "Deploy the system to the production environment.",
      imageUrl: "./assets/softwareDevelopSectionImg/softwareImg-6.png",
    },
    {
      id: 7,
      title: "Maintenance",
      description: "Provide ongoing maintenance and support for the system.",
      imageUrl: "./assets/softwareDevelopSectionImg/softwareImg-7.png",
    },
  ];
        ...
        <div>
          <div className="grid grid-cols-3 lg:gap-20 md:gap-16 gap-14">
            ...
            <div className='software-card-style custom-drop-software-develop-section' onClick={() => setSelectTab('Analysis')}>
              <img src="./assets/softwareDevelopSectionImg/softwareImg-2.png" className='w-full pt-5' alt="software develop png image" />
            ...
            <div className='software-card-style custom-drop-software-develop-section' onClick={() => setSelectTab('Design')}>
              <img src="./assets/softwareDevelopSectionImg/softwareImg-3.png" className='w-full pt-5' alt="software develop png image" />
            ...
            <div className='software-card-style custom-drop-software-develop-section' onClick={() => setSelectTab('Coding')}>
              <img src="./assets/softwareDevelopSectionImg/softwareImg-4.png" className='w-full pt-5' alt="software develop png image" />
            ...
            <div className='software-card-style custom-drop-software-develop-section' onClick={() => setSelectTab('Testing')}>
              <img src="./assets/softwareDevelopSectionImg/softwareImg-5.png" className='w-full pt-5' alt="software develop png image" />
            ...
            <div className='software-card-style custom-drop-software-develop-section' onClick={() => setSelectTab('Development')}>
              <img src="./assets/softwareDevelopSectionImg/softwareImg-6.png" className='w-full pt-5' alt="software develop png image" />
            ...
            <div className='software-card-style custom-drop-software-develop-section' onClick={() => setSelectTab('Maintenance')}>
              <img src="./assets/softwareDevelopSectionImg/softwareImg-7.png" className='w-full pt-5' alt="software develop png image" />
