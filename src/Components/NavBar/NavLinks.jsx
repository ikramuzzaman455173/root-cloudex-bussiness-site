...
const NavLinks = ({ open }) => {
  ...
  return (
    <>
      <ul className={`md:flex md:items-center lg:gap-10 md:pb-0 pb-12 text-[18px] lg:bg-transparent lg:mx-0  bg-navlinks-c text-white absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 transition-all duration-500 ease-in ${open ? 'top-15 lg:h-0 h-[500px] border-b-2' : 'top-[-490px]'}`}>
        {Links.map((link) => (
